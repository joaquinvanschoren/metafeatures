...
%
\providecommand{\manualversion}{3.0}%
\providecommand{\eeversion}{3.0}
...
\addtolength{\topsep}{-3\parskip}\addtolength{\itemsep}{-3\parskip}\clubpenalty = 10000
\widowpenalty = 10000 
...
%
\providecommand{\eenamelong}{METAL Machine Learning Experimentation Environment}%
\providecommand{\eenameshort}{\textsf{METAL--MLEE}}%
\providecommand{\citex}[1]{\textsl{(cite:~{#1})}}%
\providecommand{\note}[1]{\textbf{Note:~{#1}}}%
\providecommand{\see}[1]{$\rightarrow$~\emph{#1}}
%
\newenvironment{optionlist}{\begin{list}{}
